        ...
        <div className="flex items-center space-x-4 sm:space-x-6">
          ...
          {user ? (
            <div className="relative group">
              <div className="flex items-center space-x-1 cursor-pointer text-gray-700 hover:text-black transition-all">
                <UserRound size={20} />
                <span className="text-sm font-semibold">{user.firstName}</span>
              </div>
              <div className="absolute right-0 top-[120%] bg-white shadow-lg border border-gray-200 rounded-md p-2 z-50 hidden group-hover:flex flex-col space-y-2 w-[160px]">
                <Link
                  href="/user/profile"
                ...
                <button
                  ...
                  className="text-sm text-red-600 hover:text-red-800 transition-all text-left"
                >
                  Đăng xuất
                </button>
              </div>
